...
export default class News extends Component {
  ...
  async componentDidMount() {
    ...
    //<your-API-key>
let url = `https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=671458ab9cc64fbfb159a8cd3f29f7a4&page=1pageSize=20`;
    ...
    return (
      <div>
        <div className="container">
          <h2>NewsApp : Top {this.props.category} Headline</h2>
          <div className="row">
